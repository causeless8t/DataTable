...
namespace Causeless3t.Table
{
    public static class CsvToBinaryConverter
    {
        ...
        public static void Convert(string fileName, string csvContents, string outputBinaryPath, string aesKey)
        {
            ...
            var recordType = CreateOrGetRecordType(fileName, schema, validColumns);
            ...
            for (int i = 1; i < lines.Length; i++)
            {
                ...
                if (dictAdd == null || listAdd == null) continue;
        ...
        private static Type CreateOrGetRecordType(string className, List<(string propName, string typeName)> schema,
            List<bool> validColumns)
        {
            ...
            DynamicClassGenerator.Generate(recordClassName, schema, validColumns);
